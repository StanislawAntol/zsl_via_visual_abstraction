...
function options = CreateOptionsLocal(options)
    ...
    options.inputFolder         = options.foldersLocal{options.idxINTERACTGaze}{options.idxDataInput};
    options.outputFolder        = options.foldersLocal{options.idxINTERACTGaze}{options.idxDataOutput};
    
    %% Specifying the input file (experiment specific-might need to change!)
    options.gazeResults = options.fileINTERACTAMTGaze;
    ...
    options.avgPoseGazeFile = options.fileINTERACTavgPoseGaze;
