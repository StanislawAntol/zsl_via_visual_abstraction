            ...
            for idxDet = 1:numDetMethods
                ...
                for idxGRNNMeth = 1:numGRNNMethods
                    ...
                    elseif ( strcmp(mapMethodName, 'GRNN') )
                        ...
                        if ( randNNMatching )
                            randNNSeed = RandStream('mt19937ar','Seed', parameters.seedVal + detMethodIdxPP); % Trying to make it more consistent between different sessions
                            [predIdxsC2R, predIdxsR2C, isOrd1] = RandNearestNeighborMatching(randNNSeed, testImgFeatsForExp, testClipFeatsForExp);
                            testClipFeatsAsReal = testClipFeatsForExp;
