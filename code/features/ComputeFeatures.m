...
function ComputeFeatures(inputFile, inputDataFile, numPeople, isReal, numOrients, visualizeFeature, noiseSigma)
...
if ( computeGlobal ~= 0 )
    globalFeatures = ComputeGlobalPositionFeatures(options, inputFile, partXY, visualizeFeature, isReal);
