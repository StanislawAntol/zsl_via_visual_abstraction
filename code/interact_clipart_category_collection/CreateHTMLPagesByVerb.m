...
fprintf(mainFID, '<head><title>INTERACT Category-level Illustration Dataset</title><link rel="stylesheet" type="text/css" href="../style.css" /></head>\n');
fprintf(mainFID, '<body>\n    <h1>INTERACT Category-level Illustration Collection</h1>\n');
...
for t = 1:numTbl
    ...
    fprintf(fid, '<body>\n    <h1>INTERACT Category-level Illustration Colleciton</h1>\n');
