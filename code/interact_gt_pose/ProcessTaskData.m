...
function taskData = ProcessTaskData(options, headers, data)%,lineData, headers)

    headersWithRes = strfind( headers, 'answer_results');
    ...
    taskData = ProcessUserResults(options, taskStruct, resHeaders, resData);
